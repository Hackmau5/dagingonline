...
<body>
  ...
  <section class="page-section about-heading">
    <div class="container">
      <img class="img-fluid rounded about-heading-img mb-3 mb-lg-0" src="img/daging.jpg">
      <div class="about-heading-content2">
        <div class="row">
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              <h1 class="section-heading mb-4">
                <span class="section-heading">Special Discount For This Week</span>
              </h1>
              <h3>
                <p>Meat price promo this week. Price <b>Rp110.000/kg</b> to <b>Rp99.000/kg</b>. Hurry up and come to our cattle farm to get this promo and other promos.</p>
              </h3>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-9 mx-auto">
          <div class="cta-inner text-center rounded">
            ...
            <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
              ...
              <li class="list-unstyled-item list-hours-item d-flex">
                Monday
                <span class="ml-auto">7:00 AM - 8:00 PM</span>
              </li>
              <li class="list-unstyled-item list-hours-item d-flex">
                Tuesday
                <span class="ml-auto">7:00 AM - 8:00 PM</span>
