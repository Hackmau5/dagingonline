      ...
      <div class="intro">
        ...
        <div class="intro-text left-0 text-center bg-faded p-5 rounded">
          <h2 class="section-heading mb-4">
            <span class="section-heading-upper">Fresh Meat</span>
            <span class="section-heading-lower">Worth Your Money</span>
          </h2>
          <p class="mb-3 text-justify text-center">Every slice of our quality grades meat starts with high quality cow. Once you try it, our meat will be a blissful addition to your everyday meat - we guarantee it!
          </p>
          <div class="intro-button mx-auto">
            <a class="btn btn-primary btn-xl" href="viewdatamaster.php">Shop Now!</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <div class="cta-inner text-center rounded">
            ...
            <p class="mb-0 text-justify text-center">When you walk into our farm to choose your meat, we are dedicated to providing you with friendly service, a welcoming atmosphere, and above all else, excellent products made with the highest
              quality cow. If you are not satisfied, please let us know and we will do whatever we can to make things right!</p>
          </div>
        </div>
      </div>
    </div>
